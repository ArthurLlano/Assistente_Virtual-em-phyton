...
__all__ = [
    'STSF_LocalAppData', 'SpStream', 'SpeechRecoContextState',
    'SPRST_NUM_STATES', 'SDTReplacement', 'DISPID_SGRSTRule',
    'SpeechRecoProfileProperties', 'SVP_5', 'SGSEnabled',
    'SPAUDIOBUFFERINFO', 'SpSharedRecoContext', 'DISPID_SPPChildren',
    'SREFalseRecognition', 'SPBINARYGRAMMAR', 'DISPID_SBSWrite',
    'SPCT_COMMAND', 'SPSMF_SAPI_PROPERTIES', 'SRERequestUI',
    'SPFM_OPEN_READONLY', 'SVP_19', 'SPEI_TTS_PRIVATE', 'ISpShortcut',
    'eLEXTYPE_PRIVATE11', 'SLOStatic',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechTokenContext',
    'SAFT22kHz16BitMono', 'IInternetSecurityManager',
    'DISPID_SRGRecoContext', 'ISpRecognizer', 'SVP_17',
    'ISpeechAudioBufferInfo', 'DISPID_SWFEAvgBytesPerSec',
    'SAFT32kHz8BitMono', 'SAFTText', 'SRADynamic', 'IStream',
    'DISPID_SLPSymbolic', 'DISPID_SVAudioOutputStream',
    'SPPHRASEELEMENT', 'SAFTADPCM_22kHzMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRRAudioFormat',
    'SpeechEngineProperties', 'SAFT16kHz16BitStereo', 'SpLexicon',
    'DISPID_SpeechBaseStream', 'ISpPhoneticAlphabetSelection',
    'ISpDataKey', 'SpeechVoicePriority', 'SVP_21', 'DISPID_SVResume',
    'SpeechVoiceSkipTypeSentence', 'SP_VISEME_20', 'DISPID_SLWsCount',
    'DISPID_SPEPronunciation', 'SRESoundEnd', 'SP_VISEME_1',
    'DISPID_SRRTLength', 'eLEXTYPE_RESERVED10',
    'DISPID_SPAStartElementInResult', 'DISPID_SVSkip', 'SREPrivate',
    'SPPS_Noncontent', 'DISPID_SRGetPropertyString',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRGCmdLoadFromResource',
    'SPEI_UNDEFINED', 'SPAR_Low', 'DISPID_SOTsItem',
    'ISpeechCustomStream', 'SDTProperty', 'SVP_11',
    'SPSERIALIZEDPHRASE', 'SPVPRI_NORMAL', 'DISPID_SRGCommit',
    'DISPID_SpeechVoiceEvent', 'DISPID_SpeechRecoResultTimes',
    'SAFT24kHz8BitMono', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SpeechPhraseAlternates', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRSTsCount', 'DISPID_SVPriority',
    'DISPID_SpeechPhraseRules', 'SPPARTOFSPEECH',
    '__MIDL_IWinTypes_0009', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SOTGetAttribute', 'SAFT24kHz16BitMono',
    'DISPID_SRCEAudioLevel', 'ISpeechTextSelectionInformation',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFT8kHz8BitStereo', 'SFTSREngine',
    'DISPID_SRSetPropertyNumber', 'ISpeechMMSysAudio',
    'DISPID_SPRNumberOfElements', 'DISPID_SDKOpenKey',
    'DISPID_SPEDisplayAttributes', 'SPCT_SLEEP',
    'ISpObjectTokenCategory', 'DISPID_SLPPhoneIds', 'DISPID_SRGReset',
    'SPBO_PAUSE', 'ISpeechXMLRecoResult', 'DISPID_SPPId',
    'DISPID_SABufferNotifySize', 'SpeechTokenKeyAttributes',
    'DISPID_SVSLastBookmark', 'DISPIDSPTSI_SelectionOffset',
    'SAFT22kHz8BitMono', 'DISPID_SGRAddState',
    'SpeechRecognitionType', 'DISPID_SPRsCount',
    'SAFT24kHz8BitStereo', 'SpeechTokenShellFolder',
    'SAFTADPCM_11kHzMono', 'DISPID_SPRuleEngineConfidence',
    'SpeechInterference', 'SP_VISEME_19', 'SPSHT_Unknown',
    'SpUnCompressedLexicon', 'DISPID_SLWWord', 'SREAdaptation',
    'SPXRO_Alternates_SML', 'DISPID_SpeechRecoResult2',
    'SAFT32kHz16BitStereo', 'DISPID_SpeechAudio', 'DISPID_SPEsCount',
    'SpeechAudioState', 'SPAS_PAUSE', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SpeechPhraseAlternate', 'SPAS_RUN',
    'DISPID_SGRSTPropertyId', 'SSSPTRelativeToCurrentPosition',
    'SP_VISEME_18', 'WAVEFORMATEX', 'SpeechAudioFormatGUIDText',
    'ISpeechObjectTokenCategory', 'eLEXTYPE_RESERVED6',
    'SpObjectToken', 'SDTAlternates', 'ISpeechMemoryStream',
    'SPBO_NONE', 'DISPID_SPRFirstElement', 'DISPID_SPRuleId',
    'SPSFunction', 'DISPID_SRCEAdaptation', 'eLEXTYPE_PRIVATE7',
    'ISpeechPhraseRules', 'SVP_10', 'SVSFUnusedFlags',
    'DISPID_SPCIdToPhone', 'DISPIDSPTSI', 'SPWORDTYPE',
    'SpPhoneticAlphabetConverter', 'DISPID_SVGetVoices',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechLexicon', 'DISPID_SVEPhoneme',
    'DISPID_SGRClear', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPAsCount', 'DISPID_SPPEngineConfidence', 'SPCS_DISABLED',
    'ISpMMSysAudio', 'DISPID_SVSVisemeId', 'SpAudioFormat',
    'DISPID_SGRSAddSpecialTransition', 'ISpeechBaseStream',
    'SPFM_CREATE', 'SpeechPartOfSpeech', 'DISPID_SpeechRecoContext',
    'DISPID_SPRuleChildren', 'eWORDTYPE_DELETED',
    'SPTEXTSELECTIONINFO', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SLPsItem', 'DISPID_SGRSTWeight', 'SpeechVisemeFeature',
    'DISPID_SPIGetDisplayAttributes', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRIsUISupported', 'SpVoice', 'SVEVoiceChange',
    'DISPID_SPAsItem', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPRText', 'DISPID_SAVolume', 'SPEI_SR_PRIVATE',
    'Speech_Default_Weight', 'DISPID_SPRsItem', 'DISPID_SVVoice',
    'SAFT11kHz8BitStereo', 'DISPID_SPRuleFirstElement', 'SVEViseme',
    'eLEXTYPE_PRIVATE4', 'SPEI_RESERVED6', 'ISpeechPhraseElements',
    'SPEI_HYPOTHESIS', 'ISpNotifySink', 'DISPID_SVEStreamStart',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpeechEngineConfidence',
    'SPWT_DISPLAY', 'ISpeechWaveFormatEx', 'DISPID_SGRName',
    'DISPID_SVEStreamEnd', 'SDKLCurrentConfig', 'SFTInput',
    'SP_VISEME_7', 'SPEI_WORD_BOUNDARY', 'DISPID_SDKSetBinaryValue',
    'SPVPRI_OVER', 'DISPID_SAFGetWaveFormatEx',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPPROPERTYINFO',
    'SpeechTokenIdUserLexicon', 'DISPID_SDKDeleteKey',
    'SPBO_TIME_UNITS', 'SpeechAudioProperties',
    'SpeechRuleAttributes', 'SPSMF_UPS', 'SpeechLoadOption',
    'SAFTADPCM_44kHzStereo', 'SPPS_RESERVED3',
    'DISPID_SRCSetAdaptationData', 'SAFT12kHz16BitStereo',
    'SPADAPTATIONRELEVANCE', 'DISPID_SBSRead', 'SPPS_LMA',
    'SVEWordBoundary', 'ISpeechRecoResult2', 'SPWF_SRENGINE',
    'eLEXTYPE_PRIVATE12', 'SAFTADPCM_11kHzStereo',
    'DISPID_SVSpeakStream', 'SLODynamic',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SOTCSetId',
    'SPBOOKMARKOPTIONS', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFT44kHz16BitMono', 'DISPID_SRCEEndStream', 'DISPID_SGRsCount',
    'DISPID_SPIAudioStreamPosition', 'SVP_18', 'SPRS_INACTIVE',
    'Speech_Max_Pron_Length', 'SDA_One_Trailing_Space',
    'DISPID_SPIStartTime', 'SP_VISEME_12', 'SRERecoOtherContext',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPRS_ACTIVE',
    'DISPID_SGRsDynamic', 'SSSPTRelativeToEnd',
    'DISPID_SpeechPhraseInfo', 'SpeechVoiceSpeakFlags',
    'SPSSuppressWord', 'SPINTERFERENCE_TOOFAST', 'eLEXTYPE_PRIVATE19',
    'DISPID_SREmulateRecognition', 'SpObjectTokenCategory',
    'SPLOADOPTIONS', 'SECHighConfidence', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPANumberOfElementsInResult', 'SDTAll',
    'DISPID_SVGetProfiles', 'eLEXTYPE_PRIVATE18', 'UINT_PTR',
    'SSTTTextBuffer', 'ISpResourceManager', 'DISPID_SWFEChannels',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPAPhraseInfo',
    'SAFT44kHz8BitMono', 'DISPID_SRSetPropertyString',
    'DISPID_SMSSetData', 'DISPID_SRIsShared', 'SVEStartInputStream',
    '_ISpeechVoiceEvents', 'SPSNotOverriden',
    'DISPID_SRGSetWordSequenceData', 'SGSExclusive',
    'ISpRecoCategory', 'ISpeechPhraseReplacements', 'SVP_15',
    'SPWORDPRONUNCIATION', 'SPSHT_NotOverriden',
    'SAFT44kHz16BitStereo', 'SRCS_Enabled', 'SP_VISEME_11',
    'SRAONone', 'SAFTCCITT_ALaw_22kHzMono', 'SPEVENTSOURCEINFO',
    'SpeechGrammarTagDictation', 'DISPID_SpeechGrammarRules',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SpeechPhraseProperty',
    'DISPID_SGRSTNextState', 'SAFT22kHz8BitStereo', 'SPPS_Unknown',
    'DISPID_SFSClose', 'SpeechAudioVolume', 'ISpObjectWithToken',
    'ISpeechFileStream', 'SINoise', 'DISPID_SVESentenceBoundary',
    'DISPID_SOTCategory', 'DISPID_SVSCurrentStreamNumber',
    'tagSPTEXTSELECTIONINFO', 'SAFTGSM610_22kHzMono',
    'DISPID_SOTs_NewEnum', 'DISPID_SGRSAddRuleTransition',
    'SPWF_INPUT', 'SpeechAllElements', 'SDKLLocalMachine',
    'SpNullPhoneConverter', 'DISPID_SVSPhonemeId',
    'ISpeechRecoResultTimes', 'SAFTCCITT_ALaw_44kHzMono',
    'SSTTWildcard', 'DISPIDSPTSI_ActiveOffset', 'SPPS_Modifier',
    'DISPID_SLPsCount', 'SGRSTTRule', 'SDTLexicalForm', 'SBOPause',
    'SGRSTTTextBuffer', 'SVPOver', 'SREStreamStart',
    'DISPID_SRSAudioStatus', 'eLEXTYPE_RESERVED9',
    'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_RESERVED4', 'DISPID_SLPType',
    'SPEI_END_INPUT_STREAM', 'DISPID_SDKEnumValues', 'DISPID_SAFType',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRGState', 'SPEVENT', 'SITooLoud',
    'DISPID_SOTCEnumerateTokens', 'SPEI_MAX_SR', 'SPWT_LEXICAL',
    'DISPID_SRCreateRecoContext', 'ISpeechAudioFormat', 'SPFILEMODE',
    'ISpXMLRecoResult', 'SPEI_RESERVED2', 'SAFT16kHz8BitStereo',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPSEMANTICERRORINFO',
    'DISPID_SDKGetlongValue', 'eLEXTYPE_PRIVATE13',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRSSupportedLanguages',
    'DISPID_SPPsItem', 'SVSFNLPSpeakPunc', 'SRCS_Disabled',
    'DISPID_SRAudioInput', 'ISpStreamFormatConverter',
    'SPEI_START_SR_STREAM', 'eLEXTYPE_LETTERTOSOUND', 'SRATopLevel',
    'DISPID_SpeechLexiconWords', 'SAFT12kHz8BitMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SP_VISEME_3',
    'SPAS_STOP', 'SpeechFormatType', 'DISPID_SGRAttributes',
    'SpeechGrammarTagUnlimitedDictation', 'eLEXTYPE_RESERVED8',
    'DISPID_SWFEBlockAlign', 'eLEXTYPE_PRIVATE8', 'SPPS_RESERVED1',
    'DISPID_SRCAudioInInterferenceStatus', 'SVP_14',
    'DISPID_SpeechLexicon', 'ISpeechPhraseProperties',
    'DISPID_SVEVoiceChange', 'SpeechWordPronounceable',
    'DISPID_SOTSetId', 'SpeechCategoryRecoProfiles',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpMMAudioIn',
    'eLEXTYPE_USER_SHORTCUT', 'SPWT_PRONUNCIATION',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFTADPCM_8kHzMono',
    'DISPID_SRRDiscardResultInfo', 'SpeechRecognizerState',
    'DISPID_SGRSTransitions', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpeechLexiconPronunciations', 'DISPID_SRDisplayUI',
    'DISPID_SVEBookmark', 'ISpeechGrammarRules', 'DISPID_SRCBookmark',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRRTTickCount',
    'DISPID_SVRate', 'SPRULESTATE', 'DISPID_SVVolume',
    'DISPID_SLPPartOfSpeech', 'SpResourceManager',
    'DISPID_SABIMinNotification', 'DISPID_SLGetWords',
    'DISPID_SRGIsPronounceable', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPACommit', 'SGRSTTDictation', 'SLTUser',
    'SVSFPurgeBeforeSpeak', 'SpeechRuleState', 'SPCS_ENABLED',
    'DISPID_SPEAudioSizeTime', 'SPBO_AHEAD', 'SpeechBookmarkOptions',
    'DISPID_SpeechCustomStream', 'SPPS_RESERVED4',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVP_1', 'SVSFIsXML', 'SVF_None',
    'SVSFDefault', 'DISPID_SRGRules', 'eLEXTYPE_PRIVATE2',
    'SASClosed', 'DISPID_SRRAudio', 'SPEI_PHRASE_START',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SLRemovePronunciation',
    'SVSFIsFilename', 'DISPID_SRCEHypothesis',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechAudioStatus',
    'SpeechUserTraining', 'eLEXTYPE_PRIVATE1', 'SPSHORTCUTTYPE',
    'SPDATAKEYLOCATION', 'SVP_13', 'SGDSActive',
    'SAFTCCITT_uLaw_11kHzMono', 'SPAR_Medium', 'SREInterference',
    'SVSFVoiceMask', 'SpeechAudioFormatType', 'eLEXTYPE_PRIVATE3',
    'DISPID_SVIsUISupported', 'DISPID_SVWaitUntilDone',
    'DISPID_SRGSetTextSelection',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SP_VISEME_15',
    'DISPID_SVSInputWordLength', 'Speech_StreamPos_RealTime',
    'SpInprocRecognizer', 'SpeechStreamSeekPositionType',
    '_ISpeechRecoContextEvents', 'SPEI_MIN_SR', 'SVP_12', 'SDTAudio',
    'SPXRO_SML', 'SRTStandard', 'DISPID_SAFSetWaveFormatEx',
    'ISpeechLexiconPronunciation', 'DISPID_SLGetGenerationChange',
    'ISpEventSink', 'SREPhraseStart',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRCRequestedUIType',
    'DISPID_SPRuleConfidence', 'SpeechMicTraining', 'SPINTERFERENCE',
    'SWPUnknownWordUnpronounceable', 'SVESentenceBoundary',
    'SASPause', 'DISPID_SpeechRecoResult', 'SPXMLRESULTOPTIONS',
    'ISpeechPhraseInfo', 'SGDSActiveWithAutoPause',
    'SDA_No_Trailing_Space', 'SPSInterjection',
    'DISPID_SRGDictationLoad', 'SPSLMA', 'SPRECORESULTTIMES',
    'SWPKnownWordPronounceable', 'SRTSMLTimeout',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SGRAddResource',
    'DISPID_SPEActualConfidence', 'eLEXTYPE_RESERVED7',
    'ISpeechRecoGrammar', 'SPRST_ACTIVE',
    'SWPUnknownWordPronounceable', 'LONG_PTR',
    'SpeechRegistryLocalMachineRoot', 'SpNotifyTranslator',
    'STCLocalServer', 'SGDSInactive', 'DISPID_SRCVoice',
    'ISpeechResourceLoader', 'STSF_CommonAppData', 'DISPID_SRStatus',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPEEngineConfidence',
    'DISPID_SVEventInterests', 'STCRemoteServer',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRCRetainedAudio',
    'SREPropertyNumChange', 'SAFTGSM610_8kHzMono',
    'DISPID_SASFreeBufferSpace', 'DISPID_SpeechXMLRecoResult',
    'SpeechCategoryRecognizers', 'DISPID_SGRSTText',
    'SPSTREAMFORMATTYPE', 'DISPID_SVSLastResult',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpeechRetainedAudioOptions',
    'ISpeechPhraseInfoBuilder', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRRecognizer', 'ISpRecoContext2', 'SVEEndInputStream',
    'DISPID_SPIGetText', 'SpeechDictationTopicSpelling',
    'SPSHORTCUTPAIRLIST', 'DISPID_SpeechPhraseBuilder',
    'SDKLCurrentUser', 'DISPID_SPPName', 'SBONone', 'SVEAudioLevel',
    'SPINTERFERENCE_NOISE', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechGrammarWordType', 'DISPID_SOTsCount',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SLGetPronunciations', 'ISpeechPhraseAlternates',
    'SVEPrivate', 'DISPID_SGRsCommitAndSave', 'SPPS_Verb',
    'Speech_Max_Word_Length', 'SVEPhoneme', 'SAFTADPCM_8kHzStereo',
    'ISpGrammarBuilder', 'DISPID_SVGetAudioInputs',
    'DISPID_SDKEnumKeys', 'SVP_0', 'SP_VISEME_6',
    'DISPID_SRCVoicePurgeEvent', 'SVSFlagsAsync',
    'DISPID_SPILanguageId', 'SPPS_Function', 'SPCT_SUB_COMMAND',
    'SPEI_INTERFERENCE', 'SpeechCategoryAudioOut',
    'SRADefaultToActive', 'SpMMAudioOut',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPINTERFERENCE_NONE', 'DISPIDSPRG', 'SPVPRIORITY',
    'SpPhoneConverter', 'SVSFParseMask', 'SPAS_CLOSED',
    'SVEAllEvents', 'DISPID_SPRulesItem', 'SPEI_ADAPTATION',
    'SPAUDIOOPTIONS', 'SPRECOGNIZERSTATUS', 'SPWORD',
    'SAFTExtendedAudioFormat', 'DISPID_SRRSaveToMemory',
    'DISPID_SPEDisplayText', 'DISPID_SADefaultFormat',
    'SpeechAddRemoveWord', 'SPEI_RECO_OTHER_CONTEXT',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SVSpeakCompleteEvent', 'SRARoot',
    'ISpeechPhoneConverter', 'ISpeechRecoResultDispatch',
    'DISPID_SFSOpen', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechObjectTokens', 'DISPID_SOTMatchesAttributes',
    'SpeechCategoryAppLexicons', 'ISpeechGrammarRuleState',
    'SPGS_EXCLUSIVE', 'DISPID_SRCCreateGrammar', 'SITooQuiet',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPISaveToMemory',
    'DISPID_SpeechPhraseReplacements', 'SVPNormal',
    'ISpeechPhraseReplacement', 'SPEI_VISEME', 'DISPID_SMSGetData',
    'DISPID_SOTCDefault', 'STSF_AppData', 'DISPID_SLPLangId',
    'DISPID_SBSFormat', 'DISPID_SVDisplayUI',
    'DISPID_SRCEFalseRecognition', 'SAFTCCITT_uLaw_8kHzStereo',
    'SRSActive', 'Speech_StreamPos_Asap', 'DISPID_SPELexicalForm',
    'DISPID_SOTGetStorageFileName', 'DISPID_SGRInitialState',
    'SREBookmark', 'DISPID_SpeechPhraseElement',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SLGenerationId',
    'DISPID_SpeechPhraseReplacement', 'SDTPronunciation',
    'SGRSTTWildcard', 'SECLowConfidence', 'DISPID_SVGetAudioOutputs',
    'ISpeechAudio', 'SAFT24kHz16BitStereo',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPRules_NewEnum',
    'DISPID_SOTDataKey', 'DISPID_SAStatus', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SOTDisplayUI', 'SPCT_DICTATION', 'DISPID_SPARecoResult',
    'SVP_2', 'SPWAVEFORMATTYPE', 'DISPID_SRCESoundEnd',
    'SPEI_REQUEST_UI', 'SAFT11kHz16BitMono', 'ISpRecognizer3',
    'SAFT16kHz16BitMono', 'DISPID_SDKDeleteValue', 'SP_VISEME_8',
    'ISpLexicon', 'DISPID_SVEWord', 'IEnumString', 'SRTEmulated',
    'SPEI_RESERVED3', 'DISPID_SVSInputSentenceLength',
    'DISPID_SVEEnginePrivate', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpPhoneticAlphabetConverter', 'DISPID_SPEsItem',
    'SPEI_END_SR_STREAM', 'SASStop', 'SPLEXICONTYPE',
    'DISPID_SLAddPronunciation', 'ISpNotifyTranslator',
    'SPAO_RETAIN_AUDIO', 'SpeechTokenValueCLSID',
    'DISPID_SASCurrentDevicePosition', 'SP_VISEME_16',
    'SpTextSelectionInformation', 'DISPID_SpeechGrammarRuleState',
    'SAFTNonStandardFormat', 'DISPID_SGRSTPropertyValue',
    'SP_VISEME_13', 'SpeechCategoryVoices', 'DISPID_SMSAMMHandle',
    'ISpPhrase', 'SRAImport', 'SPSUnknown', 'SPSHT_EMAIL',
    'DISPID_SpeechPhraseRule', 'SPVISEMES', 'DISPID_SRCPause',
    'ISpAudio', 'SVP_8', 'DISPID_SOTCGetDataKey', 'SREAllEvents',
    'SPPS_SuppressWord', 'SpFileStream', 'SINone',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechLexiconType', 'SASRun',
    'SGPronounciation', 'SRSInactiveWithPurge', 'ISpStream',
    'SpeechDisplayAttributes', 'DISPID_SOTCreateInstance',
    'SSFMOpenForRead', 'SPCONTEXTSTATE', 'DISPID_SpeechVoiceStatus',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechRegistryUserRoot',
    'ISpeechRecognizerStatus', 'SpMemoryStream', 'SPAUDIOSTATUS',
    'DISPID_SLPs_NewEnum', 'SRESoundStart', 'DISPID_SABIBufferSize',
    'DISPID_SPIEngineId', 'SVPAlert', 'DISPID_SASetState',
    'SRSInactive', 'SpInProcRecoContext', 'DISPID_SRCEventInterests',
    'SREPropertyStringChange', 'DISPID_SPRs_NewEnum',
    'DISPID_SGRSTType', 'ISpeechObjectToken',
    'ISpeechPhraseAlternate', 'eLEXTYPE_MORPHOLOGY', 'SPAUDIOSTATE',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPPsCount', 'SP_VISEME_5',
    'SREStateChange', 'DISPID_SPIAudioSizeBytes', 'SPEI_MAX_TTS',
    'SpeechTokenKeyUI', 'SP_VISEME_17', 'DISPID_SDKGetStringValue',
    'SGRSTTWord', 'ISpeechObjectTokens',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPPConfidence',
    'SAFTDefault', 'SGLexicalNoSpecialChars', 'eLEXTYPE_PRIVATE20',
    'SAFT8kHz16BitMono', 'SAFTADPCM_22kHzStereo',
    'ISpeechLexiconWords', 'ISpeechPhraseElement', 'SP_VISEME_2',
    'eLEXTYPE_PRIVATE10', 'SRTExtendableParse',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SGDSActiveUserDelimited',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SWFEExtraData',
    'DISPID_SpeechMemoryStream', 'ISpStreamFormat',
    'DISPID_SVAudioOutput', 'SPEI_SOUND_START',
    'SPDKL_DefaultLocation', 'SPAR_High', 'SECNormalConfidence',
    'SVF_Emphasis', 'SPPS_Interjection',
    'DISPID_SPRDisplayAttributes', 'SVP_4', 'SAFTNoAssignedFormat',
    'DISPID_SRCState', 'DISPID_SRRPhraseInfo', 'ISpeechGrammarRule',
    'SpCompressedLexicon', 'DISPID_SpeechWaveFormatEx',
    'SECFNoSpecialChars', 'SRTReSent', 'SPSVerb', 'SPEI_TTS_BOOKMARK',
    'SPWORDLIST', 'DISPID_SPPs_NewEnum', 'DISPID_SRRAlternates',
    'eLEXTYPE_PRIVATE9', 'DISPID_SCSBaseStream',
    'SPWORDPRONUNCIATIONLIST', 'SAFT12kHz8BitStereo', 'SP_VISEME_9',
    'DISPID_SpeechMMSysAudio', 'SpeechPropertyResourceUsage',
    'DISPID_SpeechDataKey', 'SVSFParseSapi', 'ISpObjectToken',
    'ISpeechRecoContext', 'DISPID_SGRsItem',
    'SpeechVoiceCategoryTTSRate', 'SECFIgnoreKanaType',
    'DISPID_SpeechRecognizer', 'SpeechRunState', 'DISPID_SGRsCommit',
    'SPPS_Noun', 'SGRSTTEpsilon', 'SVP_3', 'DISPID_SPIReplacements',
    'SpeechPropertyComplexResponseSpeed', 'ISpRecognizer2',
    'SpWaveFormatEx', 'DISPID_SRRTStreamTime',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPERetainedSizeBytes',
    'SPSEMANTICFORMAT', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPPFirstElement', 'ISpeechVoiceStatus',
    'DISPID_SRGetPropertyNumber', 'eLEXTYPE_PRIVATE5', 'eLEXTYPE_APP',
    'DISPID_SABufferInfo', 'DISPID_SpeechGrammarRuleStateTransition',
    'SVSFIsNotXML', 'DISPID_SRCERequestUI',
    'SpeechPropertyLowConfidenceThreshold',
    'IInternetSecurityMgrSite', 'SpCustomStream',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPIProperties',
    'SPDKL_CurrentUser', 'DISPID_SBSSeek', 'DISPID_SpeechObjectToken',
    'ISpeechAudioStatus', 'DISPID_SDKSetLongValue',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPAs_NewEnum',
    'SPDKL_LocalMachine', 'DISPID_SpeechRecoContextEvents',
    'SWTAdded', 'DISPID_SVAlertBoundary', 'SVP_9',
    'DISPID_SRRRecoContext', 'DISPID_SWFESamplesPerSec',
    'SAFT32kHz8BitStereo', 'DISPID_SVStatus', 'SDTRule',
    'SPEI_RECOGNITION', 'DISPID_SVSLastBookmarkId',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGDictationSetState',
    'DISPID_SABIEventBias', 'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechGrammarRule', 'DISPID_SWFEBitsPerSample',
    ...
    'DISPID_SMSADeviceId', 'SP_VISEME_14', 'SPEI_RESERVED5',
    'DISPID_SPIGrammarId', 'SINoSignal', 'STCInprocServer',
    'DISPID_SRCESoundStart', 'DISPID_SpeechLexiconProns',
    'SREAudioLevel', 'SPPHRASEREPLACEMENT', 'SPPS_NotOverriden',
    'eLEXTYPE_USER', 'DISPID_SOTRemove', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVEAudioLevel',
    'SP_VISEME_0', 'SpeechCategoryAudioIn', 'SVP_7',
    'DISPID_SLWPronunciations', 'DISPID_SRCERecognizerStateChange',
    'SRSEIsSpeaking', 'SSFMCreate', 'ISpNotifySource',
    'DISPID_SMSALineId', 'SPFM_OPEN_READWRITE', 'ISpeechRecognizer',
    'SPPHRASE', 'DISPID_SWFEFormatTag', '_RemotableHandle',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechVoiceEvents',
    'SAFT48kHz8BitMono', 'SpeechEmulationCompareFlags',
    'DISPID_SLWLangId', 'SPGS_DISABLED', 'DISPID_SOTGetDescription',
    'SVP_20', 'SAFT8kHz16BitStereo', 'SPEVENTENUM',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'STSF_FlagCreate',
    'tagSTATSTG', 'SPEI_RECO_STATE_CHANGE', 'DISPID_SRCERecognition',
    'eLEXTYPE_PRIVATE14', 'SpeechRecoEvents', 'SVSFParseSsml',
    ...
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRGetRecognizers', 'DISPID_SOTIsUISupported',
    '_SPAUDIOSTATE', 'SRERecognition', 'DISPID_SPPNumberOfElements',
    'SVF_Stressed', 'DISPID_SRRSetTextFeedback',
    'SAFTGSM610_44kHzMono', 'SVEBookmark',
    'DISPID_SpeechAudioBufferInfo', 'SpeechStreamFileMode',
    'SPSERIALIZEDRESULT', 'SAFT48kHz8BitStereo', 'SVSFPersistXML',
    'ISpProperties', 'DISPID_SGRSTsItem', 'eLEXTYPE_PRIVATE17',
    'SPSHORTCUTPAIR', 'DISPID_SLWs_NewEnum',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SOTId',
    'SAFT32kHz16BitMono', 'SpeechSpecialTransitionType',
    'SRAORetainAudio', 'SITooFast', 'SpeechDataKeyLocation',
    'DISPID_SGRSRule', 'SGSDisabled',
    'SpeechPropertyNormalConfidenceThreshold', 'SECFIgnoreCase',
    'SVP_6', 'SGLexical', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechVoice', 'SpeechPropertyAdaptationOn', 'SLTApp',
    'SPSNoun', 'SRAExport', 'eWORDTYPE_ADDED', 'DISPID_SGRId',
    'SREStreamEnd', 'SpSharedRecognizer', 'ISpRecoGrammar2',
    'SPGS_ENABLED', 'SpeechGrammarRuleStateTransitionType',
    'SPCT_SUB_DICTATION', 'DISPID_SRCEStartStream', 'SPSModifier',
    'STCAll', 'SPVOICESTATUS', 'DISPID_SVEViseme',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRState',
    'SREHypothesis', 'SPEI_MIN_TTS',
    'SpeechPropertyHighConfidenceThreshold', 'SAFT11kHz8BitMono',
    'SPRULE', 'DISPID_SpeechAudioFormat', 'SPDKL_CurrentConfig',
    'DISPID_SRSNumberOfActiveRules', 'ISpPhraseAlt',
    'SpeechTokenKeyFiles', 'SPEI_PHONEME',
    'DISPID_SRGCmdLoadFromFile', 'SAFT44kHz8BitStereo',
    'DISPID_SPIElements', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRGCmdSetRuleState', 'SPEI_VOICE_CHANGE',
    'SpeechAudioFormatGUIDWave', 'SPPHRASEPROPERTY',
    'DISPID_SPRuleName', 'DISPID_SLWType',
    'DISPID_SPEAudioTimeOffset', 'SDTDisplayText',
    'DISPID_SPEAudioSizeBytes', 'SPVPRI_ALERT',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRGDictationUnload',
    'DISPID_SPPParent', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRAudioInputStream', 'SpeechDiscardType',
    ...
    'SpeechCategoryPhoneConverters', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpVoice', 'SECFDefault', 'SpeechVisemeType', 'DISPID_SAFGuid',
    'DISPID_SPIAudioSizeTime', 'SPLO_DYNAMIC', 'SP_VISEME_4',
    'DISPID_SRCEBookmark', 'DISPID_SVSRunningState',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechPhraseProperties', 'SPRST_INACTIVE', 'SP_VISEME_21',
    'SPGRAMMARSTATE', 'DISPID_SGRs_NewEnum', 'ISpPhoneConverter',
    'SECFIgnoreWidth', 'ISpeechLexiconWord', 'SDKLDefaultLocation',
    'SWTDeleted', 'SPAR_Unknown', 'SECFEmulateResult',
    'DISPID_SPIRule', 'SRSEDone', 'SAFT48kHz16BitStereo',
    'DISPID_SDKGetBinaryValue', 'DISPID_SOTCId', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRCRecognizer', 'DISPID_SASNonBlockingIO',
    'SAFT16kHz8BitMono', 'SpShortcut', 'SPLO_STATIC',
    'DISPID_SGRsAdd', 'DISPID_SRGetFormat',
    'DISPIDSPTSI_ActiveLength', 'SDA_Two_Trailing_Spaces',
    'SAFT12kHz16BitMono', 'SRTAutopause', 'SpeechGrammarState',
    'SpeechGrammarTagWildcard', 'DISPID_SPEs_NewEnum',
    'SPCATEGORYTYPE', 'DISPID_SPCLangId', 'ISpRecoResult',
    'DISPID_SGRSTPropertyName', 'DISPID_SRCResume',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRRSpeakAudio',
    'DISPID_SRRTimes', 'SRAInterpreter', 'DISPID_SRCEPhraseStart',
    'SVSFNLPMask', 'SpMMAudioEnum', 'DISPID_SASState', 'SPPHRASERULE',
    'SPAO_NONE', 'ISpRecoContext', 'SPGRAMMARWORDTYPE',
    'SSTTDictation', 'ISpeechVoice', 'SPEI_SR_BOOKMARK',
    'DISPID_SRProfile', 'tagSPPROPERTYINFO', 'SPSHT_OTHER',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechPhraseProperty',
    'SpStreamFormatConverter', 'SVP_16', 'SP_VISEME_10',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPRuleParent', 'DISPID_SVPause', 'SAFTGSM610_11kHzMono',
    'SSSPTRelativeToStart', 'ISpeechDataKey', 'SSFMCreateForWrite',
    'SGDisplay', 'ISpEventSource', 'DISPID_SVSInputWordPosition',
    'DISPID_SLWsItem', 'SPEI_SOUND_END', 'SVSFParseAutodetect',
    'ISpeechRecoResult', 'SAFT8kHz8BitMono', 'ISpSerializeState',
    'STCInprocHandler', 'SPRECOSTATE', 'ISpRecoGrammar',
    'ISequentialStream', 'SITooSlow', 'SPFM_NUM_MODES',
    'SpeechWordType', 'SSFMOpenReadWrite',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SpeechPhraseElements', 'SPEI_RESERVED1',
    'eLEXTYPE_PRIVATE6', 'DISPID_SPCPhoneToId', 'SRSActiveAlways',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SpeechLexiconWord',
    'DISPID_SAEventHandle', 'DISPID_SRGId', 'SAFT48kHz16BitMono',
    'DISPID_SDKSetStringValue', 'DISPID_SRSClsidEngine',
    'DISPID_SPPValue', 'eLEXTYPE_PRIVATE16', 'DISPID_SDKCreateKey',
    'SPPS_RESERVED2', 'SpPhraseInfoBuilder'
]

_check_version('1.2.1', 1700162547.225715)
